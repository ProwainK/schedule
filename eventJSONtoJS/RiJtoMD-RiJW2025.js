...
let rij_url = 'https://horaro.org/-/api/v1/events/rtaij/schedules/rtaijw2025';
let rij_data;
let rij_rawdata;
let gamedb_rawdata;
let gamedb_data;
...
// https://www.casper.tw/javascript/2017/12/28/javascript-fetch/
  ...
  fetch(rij_url, {})
    .then((response) => {
      ...
      gamedb_rawdata = fs.readFileSync('../DB/RiJW2025-game.json');
      gamedb_data = JSON.parse(gamedb_rawdata);
      // Write Start
      writeStream = fs.createWriteStream("RiJtoMD-RiJW2025.txt");
      eventInfo();
      // nowInfo();
...
function myFunction(item, index) {
  ...
  */
  ...
  writeStream.write('| ');
  try {
    if (gamedb_data[game_name]["RiJW2025"][game_rule][2] != null) {
      writeStream.write('[VOD](' + gamedb_data[game_name]["RiJW2025"][game_rule][2] + ') ');
    }
  } catch (error) {
    console.log(error);
  }
...
function eventInfo() {
  writeStream.write("---\r\n");
  writeStream.write("title: RTA in Japan Winter 2025 時程表翻譯 ლ(╹◡╹ლ)\r\n");
  writeStream.write("description: 無敵時間さん！？\r\n");
  writeStream.write("---\r\n");
  writeStream.write("\r\n");
  writeStream.write("{%hackmd @ProwainK/HJhBew8KR %}\r\n");
  writeStream.write("\r\n");
  writeStream.write("# RTA in Japan Winter 2025 時程表翻譯 ლ(╹◡╹ლ)\r\n");
  writeStream.write("\r\n");
  writeStream.write("## 台灣時間 2025 12/25 14:00 ~ 12/31 (UTC+08:00)\r\n");
  writeStream.write("\r\n");
  writeStream.write("![](https://rtain.jp/wp-content/uploads/2025/08/w2025-announce.jpg)\r\n");
  writeStream.write("\r\n");
  ...
  writeStream.write("活動頁面：https://rtain.jp/rtaij/rta-in-japan-winter-2025\r\n");
  writeStream.write("跑者投稿：https://reurl.cc/7bn2q9\r\n");
  writeStream.write("抖內項目：https://tracker.rtain.jp/bids/rtaijw2025\r\n");
  writeStream.write("ニコニコ大百科：https://reurl.cc/Xa9ANg\r\n");
  writeStream.write("官方推特 (X)：https://x.com/rtainjapan\r\n");
  writeStream.write("官方時程表：https://horaro.org/rtaij/rtaijw2025\r\n");
  writeStream.write("\r\n");
}
